...
import { updateTransactionCategory } from '../../src/handlers/money/updateTransactionCategory';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (!transactionId) return err(res, 400, 'INVALID_INPUT', 'Missing transaction id');
